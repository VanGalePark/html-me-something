function init() {
  ...
  missouri.addEventListener("click", function(event) {
    ...
    paragraphForState.innerHTML = `Although Missouri is the state that I was born in and currently live in, it's definitely the most interesting
    ...
    explainImg.innerHTML = `Picture 1: My boyfriend, Trevor, and our friend, Michael, goofed around while we walked around the WWI monument and
    looked over the ledge at Union Station. <br> Picture 2: The same day, Union station and its fountain. I put this image on google cause I thought
    it was that good.`
  })
  ...
  kansas.addEventListener("click", function(event) {
    ...
    paragraphForState.innerHTML = `I realize that because I live in Kansas City, Missouri, I have obviously been to Kansas but I do actually go further
    into Kansas than Kansas City, Kansas. I go to Spring Hill to see my grandma and grandpa, and Ottawa to see my boyfriend. Yes, the drives are very long but judging
    ...
    apparently means Moon in Japanese. She is a gray, fluffy, very lovey kitty! She will YELL at you (in meows) when she needs some attention.
    <br> Picture 2: A very pretty sunset outside of my grandparent's apartment.`
  })
  ...
  florida.addEventListener("click", function(event) {
    ...
    The last time I went, last year, was the most fun. My amazing uncle and aunt paid for me to go to Universal and I got to ride all the Harry Potter
    ...
    A view from the Cape Canaveral Exploration Tower. Some big boats, a bridge. It was really cool to see all that and more from one place. I got a
  ...
  illinois.addEventListener("click", function(event) {
    ...
    explainImg.innerHTML = `Picture 1: It's a river we passed in Chicago. I'm not sure if it's like a big river or anything but y'know it's there. <br>
    Picture 2: The Chicago Bean!! I took a selfie in this bean but that's in another picture. Very #GenZ of me I suppose. Not much to say about it except
  ...
  oregon.addEventListener("click", function(event) {
    ...
    While I was there I met my dad's cousins John and a woman I forget the name of. The woman has 3 daughters and I met 2 of them at my great
    ...
    eneded up going home with Maya, her sister, and her mom, and we had a very fun sleep over and watched Oceans 8. In the morning I met the
    third daughter, she is in college and had come home to do some laundry and have momma time. She is a very
  ...
  california.addEventListener("click", function(event) {
    ...
    van and went from Ashland to about Cresent City. We ate in a little restaurant by the ocean and some seals. We made it to this giant tree
    ...
    supposed to use it RIGHT AFTER US would just be out of luck. Also on the way to Oregon we stopped in San Francisco, I got to see the Golden Gate
